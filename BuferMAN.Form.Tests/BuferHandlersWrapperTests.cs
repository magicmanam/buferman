...
namespace BuferMAN.Form.Tests
{
    ...
    public class BuferHandlersWrapperTests
    {
        ...
        public void On_Text_format_button_has_data_as_tag_and_text_trimmed()
        {
            ...
            var wrapper = new BuferHandlersWrapper(buferService, new BuferViewModel { Clip = data }, button, A.Fake<IClipMenuGenerator>(), A.Fake<IBuferSelectionHandler>(), A.Fake<IFileStorage>());
        ...
        public void On_Unicode_format_button_has_data_as_tag_and_text_trimmed()
        {
            ...
            var wrapper = new BuferHandlersWrapper(buferService, data, button, A.Fake<IClipMenuGenerator>(), A.Fake<IBuferSelectionHandler>(), A.Fake<IFileStorage>());
        ...
        public void On_FileDrop_format_and_one_file_button_has_text_with_filename()
        {
            ...
            var wrapper = new BuferHandlersWrapper(buferService, data, button, A.Fake<IClipMenuGenerator>(), A.Fake<IBuferSelectionHandler>(), fileStorage);
